...
- `watermark_column_name` - (Optional String) The name of the watermark column.
- `watermark_expression` - (Optional String) The watermark expression, for example, `event_time - INTERVAL '5' SECOND`.
- `distributed_by_column_names` - (Optional Set of Strings) The names of the columns the table is distributed by.
- `distributed_by_buckets` - (Optional Integer) The number of buckets the table is distributed by.
