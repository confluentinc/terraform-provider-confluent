...
-> **Note:** When using Option #2, adding two identical schemas can lead to issues. [Here](https://github.com/confluentinc/terraform-provider-confluent/issues/619#issuecomment-2765360562)  is the solution for this issue. This also applies to trying to delete a ruleset which results in an already existing schema.
