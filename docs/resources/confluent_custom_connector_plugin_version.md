...
page_title: "confluent_custom_connector_plugin_version Resource - terraform-provider-confluent"
subcategory: ""
description: |-
...
`confluent_custom_connector_plugin_version` provides a Custom Connector Plugin Version resource that enables creating and deleting Custom Connector Plugin Versions on Confluent Cloud.
