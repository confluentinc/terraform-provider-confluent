...
- `rest_endpoint` - (Optional String, **Deprecated**) The REST endpoint of the Dedicated Kafka cluster, for example, `https://pkc-00000.us-central1.gcp.confluent.cloud:443`. Please use the `endpoint` attribute instead.
