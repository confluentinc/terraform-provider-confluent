...
The following end-to-end examples might help to get started with `confluent_gateway` resource:
  * [access-point-aws-egress-private-link](https://github.com/confluentinc/terraform-provider-confluent/tree/master/examples/configurations/networking/access-point-aws-egress-private-link): AWS Egress Private Link Gateway and Access Point
  * [access-point-azure-egress-private-link](https://github.com/confluentinc/terraform-provider-confluent/tree/master/examples/configurations/networking/access-point-azure-egress-private-link): Azure Egress Private Link Gateway and Access Point
  * [access-point-aws-ingress-private-link](https://github.com/confluentinc/terraform-provider-confluent/tree/master/examples/configurations/networking/access-point-aws-ingress-private-link): AWS Ingress Private Link Gateway and Access Point
  * [access-point-gcp-egress-private-service-connect](https://github.com/confluentinc/terraform-provider-confluent/tree/master/examples/configurations/networking/access-point-gcp-egress-private-service-connect): GCP Egress Private Service Connect Gateway and Access Point
  * [access-point-aws-private-network-interface](https://github.com/confluentinc/terraform-provider-confluent/tree/master/examples/configurations/networking/access-point-aws-private-network-interface): AWS Private Network Interface Gateway and Access Point
