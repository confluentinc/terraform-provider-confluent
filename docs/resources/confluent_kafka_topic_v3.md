...
page_title: "confluent_kafka_topic_v3 Resource - terraform-provider-confluent"
subcategory: ""
description: |-
...
`confluent_kafka_topic_v3` provides a Kafka Topic resource that enables creating and deleting Kafka Topics on a Kafka cluster on Confluent Cloud.
...
## Getting Started
The following end-to-end examples might help to get started with `confluent_kafka_topic_v3` resource:
