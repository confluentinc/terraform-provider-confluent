...
!> **WARNING:** `confluent_stream_governance_cluster` data source is deprecated and will be removed in the next version. Use `confluent_schema_registry_cluster` instead.
