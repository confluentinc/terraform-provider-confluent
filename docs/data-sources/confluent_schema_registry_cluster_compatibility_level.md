...
page_title: "confluent_schema_registry_cluster_compatibility_level Data Source - terraform-provider-confluent"
subcategory: ""
description: |-
  
---

# confluent_schema_registry_cluster_compatibility_level Data Source
...
`confluent_schema_registry_cluster_compatibility_level` describes a Mode data source.

## Example Usage

```terraform
data "confluent_schema_registry_cluster_compatibility_level" "example" {
...
output "compatibility_level" {
  value = data.confluent_schema_registry_cluster_compatibility_level.example.compatibility_level
}
```
