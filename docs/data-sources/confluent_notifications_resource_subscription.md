...
page_title: "confluent_notifications_resource_subscription Data Source - terraform-provider-confluent"
subcategory: ""
description: |-
  
---

# confluent_notifications_resource_subscription Data Source

[![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](https://docs.confluent.io/cloud/current/api.html#section/Versioning/API-Lifecycle-Policy)

`confluent_notifications_resource_subscription` describes a Resource Subscription data source.
...
data "confluent_notifications_resource_subscription" "example" {
  id = "res-abc123"
}

output "example" {
  value = data.confluent_notifications_resource_subscription.example
}
```
...
- `resource_name` - (String) The Confluent Resource Name of the Resource Subscription.
