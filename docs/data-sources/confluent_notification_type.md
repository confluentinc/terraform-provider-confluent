...
page_title: "confluent_notification_type Data Source - terraform-provider-confluent"
subcategory: ""
description: |-
  
---

# confluent_notification_type Data Source

[![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](https://docs.confluent.io/cloud/current/api.html#section/Versioning/API-Lifecycle-Policy)

`confluent_notification_type` describes a Notification Type data source.
...
data "confluent_notification_type" "example" {
  id = "not-abc123"
}

output "example" {
  value = data.confluent_notification_type.example
}
```
