...
- `compatibility_policy` - (Optional String) The global Schema Registry compatibility policy that governs how strictly compatibility is enforced when evolving schemas. Accepted values are: `STRICT` and `LENIENT`.
