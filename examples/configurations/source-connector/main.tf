...
resource "confluent_kafka_acl_v3" "app-connector-write-on-target-topic" {
  kafka_cluster {
    id = confluent_kafka_cluster_v2.basic.id
  }
  resource_type = "TOPIC"
...
resource "confluent_kafka_acl_v3" "app-connector-create-on-data-preview-topics" {
  kafka_cluster {
    id = confluent_kafka_cluster_v2.basic.id
  }
  resource_type = "TOPIC"
...
resource "confluent_kafka_acl_v3" "app-connector-write-on-data-preview-topics" {
  kafka_cluster {
    id = confluent_kafka_cluster_v2.basic.id
  }
  resource_type = "TOPIC"
