...
#   cloud_api_secret = var.confluent_cloud_api_secret
  cloud_api_key    = "ND3DPTCGZFQ5SOGA"
  cloud_api_secret = "tuImM5UhQ/MPc667P4QTbA/FS/UfL8yaZs1Qs1MHJVb6kF34ZGF1hY2BDe3kI5Ij"
...
#   content_format = "JSON"
  region = "us-east-1"
  cloud = "AWS"
  display_name = "flink_artifact_main"
  content_format = "JAR"
  artifact_file = "/Users/tusharmalik/Downloads/3KB.jar"
}