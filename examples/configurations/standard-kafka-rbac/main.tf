...
resource "confluentcloud_role_binding" "app-producer-developer-write" {
  ...
  crn_pattern = "${confluentcloud_kafka_cluster.standard.rbac_crn}/kafka=${confluentcloud_kafka_cluster.standard.id}/topic=${confluentcloud_kafka_topic.orders.topic_name}"
}
...
resource "confluentcloud_role_binding" "app-producer-developer-read-from-group" {
  ...
  crn_pattern = "${confluentcloud_kafka_cluster.standard.rbac_crn}/kafka=${confluentcloud_kafka_cluster.standard.id}/group=confluent_cli_consumer_*"
}
