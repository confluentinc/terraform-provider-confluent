...
resource "confluent_service_account" "app-manager" {
  ...
  description  = "Service account to manage ${var.kafka_id} Kafka cluster"
}
...
resource "confluent_service_account" "app-producer" {
  ...
  description  = "Service account to produce to '${var.topic_name}' topic of ${var.kafka_id} Kafka cluster"
}
