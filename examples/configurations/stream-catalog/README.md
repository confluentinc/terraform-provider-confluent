...
2. See the following docs for more details:
    ...
    * [Stream Catalog on Confluent Cloud User Guide](https://docs.confluent.io/cloud/current/stream-governance/stream-catalog.html).
