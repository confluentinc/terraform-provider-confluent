...
type IPFilterSummariesIamV2Api interface {
...
Make a request to read an IP filter summary.
	 ...
	 @return ApiGetIamV2IpFilterSummaryRequest
	*/
	GetIamV2IpFilterSummary(ctx _context.Context) ApiGetIamV2IpFilterSummaryRequest

	// GetIamV2IpFilterSummaryExecute executes the request
	//  @return IamV2IpFilterSummary
	GetIamV2IpFilterSummaryExecute(r ApiGetIamV2IpFilterSummaryRequest) (IamV2IpFilterSummary, *_nethttp.Response, error)
}

// IPFilterSummariesIamV2ApiService IPFilterSummariesIamV2Api service
type IPFilterSummariesIamV2ApiService service

type ApiGetIamV2IpFilterSummaryRequest struct {
	ctx _context.Context
	ApiService IPFilterSummariesIamV2Api
	scope *string
}
...
func (r ApiGetIamV2IpFilterSummaryRequest) Execute() (IamV2IpFilterSummary, *_nethttp.Response, error) {
	return r.ApiService.GetIamV2IpFilterSummaryExecute(r)
}
...
func (a *IPFilterSummariesIamV2ApiService) GetIamV2IpFilterSummaryExecute(r ApiGetIamV2IpFilterSummaryRequest) (IamV2IpFilterSummary, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  IamV2IpFilterSummary
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IPFilterSummariesIamV2ApiService.GetIamV2IpFilterSummary")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/iam/v2/ip-filter-summary"
