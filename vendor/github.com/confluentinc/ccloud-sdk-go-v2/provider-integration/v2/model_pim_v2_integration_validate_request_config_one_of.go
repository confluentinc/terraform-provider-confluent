...
func PimV2AwsIntegrationConfigAsPimV2IntegrationValidateRequestConfigOneOf(v *PimV2AwsIntegrationConfig) PimV2IntegrationValidateRequestConfigOneOf {
	return PimV2IntegrationValidateRequestConfigOneOf{PimV2AwsIntegrationConfig: v}
}
...
func PimV2AzureIntegrationConfigAsPimV2IntegrationValidateRequestConfigOneOf(v *PimV2AzureIntegrationConfig) PimV2IntegrationValidateRequestConfigOneOf {
	return PimV2IntegrationValidateRequestConfigOneOf{PimV2AzureIntegrationConfig: v}
}
...
func PimV2GcpIntegrationConfigAsPimV2IntegrationValidateRequestConfigOneOf(v *PimV2GcpIntegrationConfig) PimV2IntegrationValidateRequestConfigOneOf {
	return PimV2IntegrationValidateRequestConfigOneOf{PimV2GcpIntegrationConfig: v}
}
...
func (dst *PimV2IntegrationValidateRequestConfigOneOf) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["kind"] == "AwsIntegrationConfig" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal PimV2IntegrationValidateRequestConfigOneOf as PimV2AwsIntegrationConfig: %s", err.Error())
		}
	}
	...
	if jsonDict["kind"] == "AzureIntegrationConfig" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal PimV2IntegrationValidateRequestConfigOneOf as PimV2AzureIntegrationConfig: %s", err.Error())
		}
	}
	...
	if jsonDict["kind"] == "GcpIntegrationConfig" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal PimV2IntegrationValidateRequestConfigOneOf as PimV2GcpIntegrationConfig: %s", err.Error())
		}
	}
...
type NullablePimV2IntegrationValidateRequestConfigOneOf struct {
	value *PimV2IntegrationValidateRequestConfigOneOf
	isSet bool
}
...
func NewNullablePimV2IntegrationValidateRequestConfigOneOf(val *PimV2IntegrationValidateRequestConfigOneOf) *NullablePimV2IntegrationValidateRequestConfigOneOf {
	return &NullablePimV2IntegrationValidateRequestConfigOneOf{value: val, isSet: true}
}
