...
type IntegrationsPimV1Api interface {
	...
	*/
	...
	// CreatePimV1IntegrationExecute executes the request
	...
	*/
	...
	// DeletePimV1IntegrationExecute executes the request
	...
	*/
	...
	// GetPimV1IntegrationExecute executes the request
	//  @return PimV1Integration
	...
	*/
	...
	// ListPimV1IntegrationsExecute executes the request
	//  @return PimV1IntegrationList
	ListPimV1IntegrationsExecute(r ApiListPimV1IntegrationsRequest) (PimV1IntegrationList, *_nethttp.Response, error)
}

// IntegrationsPimV1ApiService IntegrationsPimV1Api service
...
func (r ApiCreatePimV1IntegrationRequest) PimV1Integration(pimV1Integration PimV1Integration) ApiCreatePimV1IntegrationRequest {
	r.pimV1Integration = &pimV1Integration
	return r
}

func (r ApiCreatePimV1IntegrationRequest) Execute() (PimV1Integration, *_nethttp.Response, error) {
	return r.ApiService.CreatePimV1IntegrationExecute(r)
}
...
func (a *IntegrationsPimV1ApiService) CreatePimV1IntegrationExecute(r ApiCreatePimV1IntegrationRequest) (PimV1Integration, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  PimV1Integration
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IntegrationsPimV1ApiService.CreatePimV1Integration")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/pim/v1/integrations"
	...
	// body params
	localVarPostBody = r.pimV1Integration
...
func (r ApiDeletePimV1IntegrationRequest) Environment(environment string) ApiDeletePimV1IntegrationRequest {
	r.environment = &environment
	return r
}

func (r ApiDeletePimV1IntegrationRequest) Execute() (*_nethttp.Response, error) {
	return r.ApiService.DeletePimV1IntegrationExecute(r)
}
...
// Execute executes the request
func (a *IntegrationsPimV1ApiService) DeletePimV1IntegrationExecute(r ApiDeletePimV1IntegrationRequest) (*_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IntegrationsPimV1ApiService.DeletePimV1Integration")
	if err != nil {
		return nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/pim/v1/integrations/{id}"
...
// Scope the operation to the given environment.
func (r ApiGetPimV1IntegrationRequest) Environment(environment string) ApiGetPimV1IntegrationRequest {
	r.environment = &environment
	return r
}

func (r ApiGetPimV1IntegrationRequest) Execute() (PimV1Integration, *_nethttp.Response, error) {
	return r.ApiService.GetPimV1IntegrationExecute(r)
}
...
func (a *IntegrationsPimV1ApiService) GetPimV1IntegrationExecute(r ApiGetPimV1IntegrationRequest) (PimV1Integration, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IntegrationsPimV1ApiService.GetPimV1Integration")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiListPimV1IntegrationsRequest) Environment(environment string) ApiListPimV1IntegrationsRequest {
	r.environment = &environment
	return r
}
...
func (r ApiListPimV1IntegrationsRequest) Execute() (PimV1IntegrationList, *_nethttp.Response, error) {
	return r.ApiService.ListPimV1IntegrationsExecute(r)
}
...
func (a *IntegrationsPimV1ApiService) ListPimV1IntegrationsExecute(r ApiListPimV1IntegrationsRequest) (PimV1IntegrationList, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  PimV1IntegrationList
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IntegrationsPimV1ApiService.ListPimV1Integrations")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
