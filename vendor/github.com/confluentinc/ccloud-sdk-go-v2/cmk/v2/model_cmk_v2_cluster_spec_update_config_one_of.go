...
func CmkV2FreightAsCmkV2ClusterSpecUpdateConfigOneOf(v *CmkV2Freight) CmkV2ClusterSpecUpdateConfigOneOf {
	return CmkV2ClusterSpecUpdateConfigOneOf{CmkV2Freight: v}
}
...
func (dst *CmkV2ClusterSpecUpdateConfigOneOf) UnmarshalJSON(data []byte) error {
	...
	// check if the discriminator value is 'Freight'
	if jsonDict["kind"] == "Freight" {
		// try to unmarshal JSON data into CmkV2Freight
		err = json.Unmarshal(data, &dst.CmkV2Freight)
		if err == nil {
			return nil // data stored in dst.CmkV2Freight, return on the first match
		} else {
			dst.CmkV2Freight = nil
			return fmt.Errorf("Failed to unmarshal CmkV2ClusterSpecUpdateConfigOneOf as CmkV2Freight: %s", err.Error())
		}
	}
	...
	// check if the discriminator value is 'cmk.v2.Freight'
	if jsonDict["kind"] == "cmk.v2.Freight" {
		// try to unmarshal JSON data into CmkV2Freight
		err = json.Unmarshal(data, &dst.CmkV2Freight)
		if err == nil {
			return nil // data stored in dst.CmkV2Freight, return on the first match
...
func (src CmkV2ClusterSpecUpdateConfigOneOf) MarshalJSON() ([]byte, error) {
	...
	if src.CmkV2Freight != nil {
		buffer := &bytes.Buffer{}
		encoder := json.NewEncoder(buffer)
		encoder.SetEscapeHTML(false)
		err := encoder.Encode(&src.CmkV2Freight)
		return buffer.Bytes(), err
	}
...
func (obj *CmkV2ClusterSpecUpdateConfigOneOf) GetActualInstance() interface{} {
	...
	if obj.CmkV2Freight != nil {
		return obj.CmkV2Freight
	}
