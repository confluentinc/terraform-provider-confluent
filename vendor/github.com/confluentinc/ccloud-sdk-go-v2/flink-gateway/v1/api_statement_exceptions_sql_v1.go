...
func (r ApiGetSqlv1StatementExceptionsRequest) Execute() (SqlV1StatementExceptionList, *_nethttp.Response, error) {
	return r.ApiService.GetSqlv1StatementExceptionsExecute(r)
}
...
//
//	@return SqlV1StatementExceptionList
func (a *StatementExceptionsSqlV1ApiService) GetSqlv1StatementExceptionsExecute(r ApiGetSqlv1StatementExceptionsRequest) (SqlV1StatementExceptionList, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  SqlV1StatementExceptionList
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StatementExceptionsSqlV1ApiService.GetSqlv1StatementExceptions")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/sql/v1/organizations/{organization_id}/environments/{environment_id}/statements/{statement_name}/exceptions"
