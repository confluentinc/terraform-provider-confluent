...
type NetworkingV1DnsForwarderList struct {
	...
	Data []NetworkingV1DnsForwarder `json:"data,omitempty"`
}
...
func NewNetworkingV1DnsForwarderList(apiVersion string, kind string, metadata ListMeta, data []NetworkingV1DnsForwarder) *NetworkingV1DnsForwarderList {
	this := NetworkingV1DnsForwarderList{}
...
func (o *NetworkingV1DnsForwarderList) GetData() []NetworkingV1DnsForwarder {
	if o == nil {
		var ret []NetworkingV1DnsForwarder
		return ret
	}
...
func (o *NetworkingV1DnsForwarderList) recurseRedact(v interface{}) {
...
func (o NetworkingV1DnsForwarderList) zeroField(v interface{}) {
...
type NullableNetworkingV1DnsForwarderList struct {
	value *NetworkingV1DnsForwarderList
	isSet bool
}
...
func NewNullableNetworkingV1DnsForwarderList(val *NetworkingV1DnsForwarderList) *NullableNetworkingV1DnsForwarderList {
	return &NullableNetworkingV1DnsForwarderList{value: val, isSet: true}
}
