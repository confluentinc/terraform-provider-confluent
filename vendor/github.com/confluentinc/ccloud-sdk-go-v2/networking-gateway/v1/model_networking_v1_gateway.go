...
func (o *NetworkingV1Gateway) GetSpec() NetworkingV1GatewaySpec {
	if o == nil || o.Spec == nil {
		var ret NetworkingV1GatewaySpec
		return ret
	}
	return *o.Spec
}
...
func (o NetworkingV1Gateway) zeroField(v interface{}) {
...
type NullableNetworkingV1Gateway struct {
	value *NetworkingV1Gateway
	isSet bool
}

func (v NullableNetworkingV1Gateway) Get() *NetworkingV1Gateway {
	return v.value
}

func (v *NullableNetworkingV1Gateway) Set(val *NetworkingV1Gateway) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1Gateway) IsSet() bool {
	return v.isSet
}
...
func NewNullableNetworkingV1Gateway(val *NetworkingV1Gateway) *NullableNetworkingV1Gateway {
	return &NullableNetworkingV1Gateway{value: val, isSet: true}
}
