...
func NewNetworkingV1NetworkLinkService() *NetworkingV1NetworkLinkService {
	this := NetworkingV1NetworkLinkService{}
	return &this
}
...
func (o *NetworkingV1NetworkLinkService) GetSpec() NetworkingV1NetworkLinkServiceSpec {
	if o == nil || o.Spec == nil {
		var ret NetworkingV1NetworkLinkServiceSpec
		return ret
	}
	return *o.Spec
}
...
func (o *NetworkingV1NetworkLinkService) recurseRedact(v interface{}) {
...
func (o NetworkingV1NetworkLinkService) zeroField(v interface{}) {
...
type NullableNetworkingV1NetworkLinkService struct {
	value *NetworkingV1NetworkLinkService
	isSet bool
}

func (v NullableNetworkingV1NetworkLinkService) Get() *NetworkingV1NetworkLinkService {
	return v.value
}

func (v *NullableNetworkingV1NetworkLinkService) Set(val *NetworkingV1NetworkLinkService) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1NetworkLinkService) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1NetworkLinkService) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1NetworkLinkService(val *NetworkingV1NetworkLinkService) *NullableNetworkingV1NetworkLinkService {
	return &NullableNetworkingV1NetworkLinkService{value: val, isSet: true}
}
