...
func NewNetworkingV1PrivateLinkAccess() *NetworkingV1PrivateLinkAccess {
	this := NetworkingV1PrivateLinkAccess{}
	return &this
}
...
func (o *NetworkingV1PrivateLinkAccess) GetSpec() NetworkingV1PrivateLinkAccessSpec {
	if o == nil || o.Spec == nil {
		var ret NetworkingV1PrivateLinkAccessSpec
		return ret
	}
	return *o.Spec
}
...
type NullableNetworkingV1PrivateLinkAccess struct {
	value *NetworkingV1PrivateLinkAccess
	isSet bool
}

func (v NullableNetworkingV1PrivateLinkAccess) Get() *NetworkingV1PrivateLinkAccess {
	return v.value
}

func (v *NullableNetworkingV1PrivateLinkAccess) Set(val *NetworkingV1PrivateLinkAccess) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1PrivateLinkAccess) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1PrivateLinkAccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1PrivateLinkAccess(val *NetworkingV1PrivateLinkAccess) *NullableNetworkingV1PrivateLinkAccess {
	return &NullableNetworkingV1PrivateLinkAccess{value: val, isSet: true}
}
