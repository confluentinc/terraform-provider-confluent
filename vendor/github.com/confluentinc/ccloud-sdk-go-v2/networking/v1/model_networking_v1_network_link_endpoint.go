...
func NewNetworkingV1NetworkLinkEndpoint() *NetworkingV1NetworkLinkEndpoint {
	this := NetworkingV1NetworkLinkEndpoint{}
	return &this
}
...
func (o *NetworkingV1NetworkLinkEndpoint) GetSpec() NetworkingV1NetworkLinkEndpointSpec {
	if o == nil || o.Spec == nil {
		var ret NetworkingV1NetworkLinkEndpointSpec
		return ret
	}
	return *o.Spec
}
...
func (o *NetworkingV1NetworkLinkEndpoint) recurseRedact(v interface{}) {
...
func (o NetworkingV1NetworkLinkEndpoint) zeroField(v interface{}) {
...
type NullableNetworkingV1NetworkLinkEndpoint struct {
	value *NetworkingV1NetworkLinkEndpoint
	isSet bool
}

func (v NullableNetworkingV1NetworkLinkEndpoint) Get() *NetworkingV1NetworkLinkEndpoint {
	return v.value
}

func (v *NullableNetworkingV1NetworkLinkEndpoint) Set(val *NetworkingV1NetworkLinkEndpoint) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1NetworkLinkEndpoint) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1NetworkLinkEndpoint) Unset() {
	v.value = nil
	v.isSet = false
}
...
func NewNullableNetworkingV1NetworkLinkEndpoint(val *NetworkingV1NetworkLinkEndpoint) *NullableNetworkingV1NetworkLinkEndpoint {
	return &NullableNetworkingV1NetworkLinkEndpoint{value: val, isSet: true}
}
