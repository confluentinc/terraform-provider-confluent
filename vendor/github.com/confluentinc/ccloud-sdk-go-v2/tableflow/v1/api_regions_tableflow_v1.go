...
type RegionsTableflowV1Api interface {
	...
	*/
	...
	// ListTableflowV1RegionsExecute executes the request
	//  @return TableflowV1RegionList
	ListTableflowV1RegionsExecute(r ApiListTableflowV1RegionsRequest) (TableflowV1RegionList, *_nethttp.Response, error)
}

// RegionsTableflowV1ApiService RegionsTableflowV1Api service
...
func (r ApiListTableflowV1RegionsRequest) Cloud(cloud string) ApiListTableflowV1RegionsRequest {
	r.cloud = &cloud
	return r
}
...
func (r ApiListTableflowV1RegionsRequest) Execute() (TableflowV1RegionList, *_nethttp.Response, error) {
	return r.ApiService.ListTableflowV1RegionsExecute(r)
}
...
func (a *RegionsTableflowV1ApiService) ListTableflowV1RegionsExecute(r ApiListTableflowV1RegionsRequest) (TableflowV1RegionList, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  TableflowV1RegionList
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RegionsTableflowV1ApiService.ListTableflowV1Regions")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/tableflow/v1/regions"
