...
// TableflowV1CatalogIntegrationList A Catalog Integration represents configuration related to a catalog integration   ## The Catalog Integrations Model <SchemaDefinition schemaRef=\"#/components/schemas/tableflow.v1.CatalogIntegration\" />
type TableflowV1CatalogIntegrationList struct {
	...
	Data []TableflowV1CatalogIntegration `json:"data,omitempty"`
}
...
func NewTableflowV1CatalogIntegrationList(apiVersion string, kind string, metadata ListMeta, data []TableflowV1CatalogIntegration) *TableflowV1CatalogIntegrationList {
	this := TableflowV1CatalogIntegrationList{}
...
func (o *TableflowV1CatalogIntegrationList) GetData() []TableflowV1CatalogIntegration {
	if o == nil {
		var ret []TableflowV1CatalogIntegration
		return ret
	}
...
func (o *TableflowV1CatalogIntegrationList) Redact() {
...
func (o *TableflowV1CatalogIntegrationList) recurseRedact(v interface{}) {
...
func (o TableflowV1CatalogIntegrationList) zeroField(v interface{}) {
	p := reflect.ValueOf(v).Elem()
	p.Set(reflect.Zero(p.Type()))
}

func (o TableflowV1CatalogIntegrationList) MarshalJSON() ([]byte, error) {
...
type NullableTableflowV1CatalogIntegrationList struct {
	value *TableflowV1CatalogIntegrationList
	isSet bool
}

func (v NullableTableflowV1CatalogIntegrationList) Get() *TableflowV1CatalogIntegrationList {
	return v.value
}

func (v *NullableTableflowV1CatalogIntegrationList) Set(val *TableflowV1CatalogIntegrationList) {
	v.value = val
	v.isSet = true
}

func (v NullableTableflowV1CatalogIntegrationList) IsSet() bool {
	return v.isSet
}

func (v *NullableTableflowV1CatalogIntegrationList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTableflowV1CatalogIntegrationList(val *TableflowV1CatalogIntegrationList) *NullableTableflowV1CatalogIntegrationList {
	return &NullableTableflowV1CatalogIntegrationList{value: val, isSet: true}
}

func (v NullableTableflowV1CatalogIntegrationList) MarshalJSON() ([]byte, error) {
	buffer := &bytes.Buffer{}
	encoder := json.NewEncoder(buffer)
	encoder.SetEscapeHTML(false)
...
func (v *NullableTableflowV1CatalogIntegrationList) UnmarshalJSON(src []byte) error {
	v.isSet = true
