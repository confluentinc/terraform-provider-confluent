...
// TableflowV1CatalogIntegration A Catalog Integration represents configuration related to a catalog integration   ## The Catalog Integrations Model <SchemaDefinition schemaRef=\"#/components/schemas/tableflow.v1.CatalogIntegration\" />
...
func NewTableflowV1CatalogIntegration() *TableflowV1CatalogIntegration {
	this := TableflowV1CatalogIntegration{}
	return &this
}
...
func (o *TableflowV1CatalogIntegration) GetSpec() TableflowV1CatalogIntegrationSpec {
	if o == nil || o.Spec == nil {
		var ret TableflowV1CatalogIntegrationSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given TableflowV1CatalogIntegrationSpec and assigns it to the Spec field.
...
func (o *TableflowV1CatalogIntegration) GetStatus() TableflowV1CatalogIntegrationStatus {
	if o == nil || o.Status == nil {
		var ret TableflowV1CatalogIntegrationStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given TableflowV1CatalogIntegrationStatus and assigns it to the Status field.
func (o *TableflowV1CatalogIntegration) SetStatus(v TableflowV1CatalogIntegrationStatus) {
	o.Status = &v
}

// Redact resets all sensitive fields to their zero value.
func (o *TableflowV1CatalogIntegration) Redact() {
...
func (o *TableflowV1CatalogIntegration) recurseRedact(v interface{}) {
...
func (o TableflowV1CatalogIntegration) zeroField(v interface{}) {
	p := reflect.ValueOf(v).Elem()
	p.Set(reflect.Zero(p.Type()))
}

func (o TableflowV1CatalogIntegration) MarshalJSON() ([]byte, error) {
...
type NullableTableflowV1CatalogIntegration struct {
	value *TableflowV1CatalogIntegration
	isSet bool
}

func (v NullableTableflowV1CatalogIntegration) Get() *TableflowV1CatalogIntegration {
	return v.value
}

func (v *NullableTableflowV1CatalogIntegration) Set(val *TableflowV1CatalogIntegration) {
	v.value = val
	v.isSet = true
}

func (v NullableTableflowV1CatalogIntegration) IsSet() bool {
	return v.isSet
}

func (v *NullableTableflowV1CatalogIntegration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTableflowV1CatalogIntegration(val *TableflowV1CatalogIntegration) *NullableTableflowV1CatalogIntegration {
	return &NullableTableflowV1CatalogIntegration{value: val, isSet: true}
}

func (v NullableTableflowV1CatalogIntegration) MarshalJSON() ([]byte, error) {
	buffer := &bytes.Buffer{}
	encoder := json.NewEncoder(buffer)
	encoder.SetEscapeHTML(false)
...
func (v *NullableTableflowV1CatalogIntegration) UnmarshalJSON(src []byte) error {
	v.isSet = true
