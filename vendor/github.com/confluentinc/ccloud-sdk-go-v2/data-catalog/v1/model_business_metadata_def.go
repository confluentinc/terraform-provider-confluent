...
func (o *BusinessMetadataDef) recurseRedact(v interface{}) {
...
func (o BusinessMetadataDef) zeroField(v interface{}) {
...
type NullableBusinessMetadataDef struct {
	value *BusinessMetadataDef
	isSet bool
}

func (v NullableBusinessMetadataDef) Get() *BusinessMetadataDef {
	return v.value
}

func (v *NullableBusinessMetadataDef) Set(val *BusinessMetadataDef) {
	v.value = val
	v.isSet = true
}

func (v NullableBusinessMetadataDef) IsSet() bool {
	return v.isSet
}
...
func NewNullableBusinessMetadataDef(val *BusinessMetadataDef) *NullableBusinessMetadataDef {
	return &NullableBusinessMetadataDef{value: val, isSet: true}
}
