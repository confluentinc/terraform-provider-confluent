...
type IamV2IdentityProviderList struct {
	...
	Data []IamV2IdentityProvider `json:"data,omitempty"`
}
...
func NewIamV2IdentityProviderList(apiVersion string, kind string, metadata ListMeta, data []IamV2IdentityProvider) *IamV2IdentityProviderList {
	this := IamV2IdentityProviderList{}
...
func (o *IamV2IdentityProviderList) recurseRedact(v interface{}) {
...
func (o IamV2IdentityProviderList) zeroField(v interface{}) {
...
type NullableIamV2IdentityProviderList struct {
	value *IamV2IdentityProviderList
	isSet bool
}

func (v NullableIamV2IdentityProviderList) Get() *IamV2IdentityProviderList {
	return v.value
}

func (v *NullableIamV2IdentityProviderList) Set(val *IamV2IdentityProviderList) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2IdentityProviderList) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2IdentityProviderList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2IdentityProviderList(val *IamV2IdentityProviderList) *NullableIamV2IdentityProviderList {
	return &NullableIamV2IdentityProviderList{value: val, isSet: true}
}
