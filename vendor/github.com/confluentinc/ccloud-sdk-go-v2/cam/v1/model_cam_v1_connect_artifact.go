...
func (o *CamV1ConnectArtifact) GetSpec() CamV1ConnectArtifactSpec {
	if o == nil || o.Spec == nil {
		var ret CamV1ConnectArtifactSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given CamV1ConnectArtifactSpec and assigns it to the Spec field.
...
func (o *CamV1ConnectArtifact) GetStatus() CamV1ConnectArtifactStatus {
	if o == nil || o.Status == nil {
		var ret CamV1ConnectArtifactStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given CamV1ConnectArtifactStatus and assigns it to the Status field.
func (o *CamV1ConnectArtifact) SetStatus(v CamV1ConnectArtifactStatus) {
	o.Status = &v
}

// Redact resets all sensitive fields to their zero value.
func (o *CamV1ConnectArtifact) Redact() {
...
func (o *CamV1ConnectArtifact) recurseRedact(v interface{}) {
...
func (o CamV1ConnectArtifact) zeroField(v interface{}) {
	p := reflect.ValueOf(v).Elem()
	p.Set(reflect.Zero(p.Type()))
}

func (o CamV1ConnectArtifact) MarshalJSON() ([]byte, error) {
...
type NullableCamV1ConnectArtifact struct {
	value *CamV1ConnectArtifact
	isSet bool
}

func (v NullableCamV1ConnectArtifact) Get() *CamV1ConnectArtifact {
	return v.value
}

func (v *NullableCamV1ConnectArtifact) Set(val *CamV1ConnectArtifact) {
	v.value = val
	v.isSet = true
}

func (v NullableCamV1ConnectArtifact) IsSet() bool {
	return v.isSet
}

func (v *NullableCamV1ConnectArtifact) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCamV1ConnectArtifact(val *CamV1ConnectArtifact) *NullableCamV1ConnectArtifact {
	return &NullableCamV1ConnectArtifact{value: val, isSet: true}
}

func (v NullableCamV1ConnectArtifact) MarshalJSON() ([]byte, error) {
	buffer := &bytes.Buffer{}
	encoder := json.NewEncoder(buffer)
	encoder.SetEscapeHTML(false)
...
func (v *NullableCamV1ConnectArtifact) UnmarshalJSON(src []byte) error {
	v.isSet = true
