...
// CamV1UploadSourcePresignedUrl Presigned URL of the uploaded Connect Artifact archive.
...
func NewCamV1UploadSourcePresignedUrl(location string, uploadId string) *CamV1UploadSourcePresignedUrl {
	this := CamV1UploadSourcePresignedUrl{}
...
func (o *CamV1UploadSourcePresignedUrl) Redact() {
	o.recurseRedact(&o.Location)
	o.recurseRedact(&o.UploadId)
}

func (o *CamV1UploadSourcePresignedUrl) recurseRedact(v interface{}) {
...
func (o CamV1UploadSourcePresignedUrl) zeroField(v interface{}) {
	p := reflect.ValueOf(v).Elem()
	p.Set(reflect.Zero(p.Type()))
}

func (o CamV1UploadSourcePresignedUrl) MarshalJSON() ([]byte, error) {
...
type NullableCamV1UploadSourcePresignedUrl struct {
	value *CamV1UploadSourcePresignedUrl
	isSet bool
}

func (v NullableCamV1UploadSourcePresignedUrl) Get() *CamV1UploadSourcePresignedUrl {
	return v.value
}

func (v *NullableCamV1UploadSourcePresignedUrl) Set(val *CamV1UploadSourcePresignedUrl) {
	v.value = val
	v.isSet = true
}

func (v NullableCamV1UploadSourcePresignedUrl) IsSet() bool {
	return v.isSet
}

func (v *NullableCamV1UploadSourcePresignedUrl) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCamV1UploadSourcePresignedUrl(val *CamV1UploadSourcePresignedUrl) *NullableCamV1UploadSourcePresignedUrl {
	return &NullableCamV1UploadSourcePresignedUrl{value: val, isSet: true}
}

func (v NullableCamV1UploadSourcePresignedUrl) MarshalJSON() ([]byte, error) {
	buffer := &bytes.Buffer{}
	encoder := json.NewEncoder(buffer)
	encoder.SetEscapeHTML(false)
...
func (v *NullableCamV1UploadSourcePresignedUrl) UnmarshalJSON(src []byte) error {
	v.isSet = true
