...
func (o *ConfigDefaultMetadata) recurseRedact(v interface{}) {
...
func (o ConfigDefaultMetadata) zeroField(v interface{}) {
...
func NewNullableConfigDefaultMetadata(val *ConfigDefaultMetadata) *NullableConfigDefaultMetadata {
	return &NullableConfigDefaultMetadata{value: val, isSet: true}
}
