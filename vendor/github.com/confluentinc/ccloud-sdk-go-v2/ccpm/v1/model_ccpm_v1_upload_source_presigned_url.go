...
// CcpmV1UploadSourcePresignedUrl Presigned URL of the uploaded Custom Connect Plugin archive.
...
func NewCcpmV1UploadSourcePresignedUrl(location string, uploadId string) *CcpmV1UploadSourcePresignedUrl {
	this := CcpmV1UploadSourcePresignedUrl{}
...
func (o *CcpmV1UploadSourcePresignedUrl) Redact() {
	o.recurseRedact(&o.Location)
	o.recurseRedact(&o.UploadId)
}

func (o *CcpmV1UploadSourcePresignedUrl) recurseRedact(v interface{}) {
...
func (o CcpmV1UploadSourcePresignedUrl) zeroField(v interface{}) {
	p := reflect.ValueOf(v).Elem()
	p.Set(reflect.Zero(p.Type()))
}

func (o CcpmV1UploadSourcePresignedUrl) MarshalJSON() ([]byte, error) {
...
type NullableCcpmV1UploadSourcePresignedUrl struct {
	value *CcpmV1UploadSourcePresignedUrl
	isSet bool
}

func (v NullableCcpmV1UploadSourcePresignedUrl) Get() *CcpmV1UploadSourcePresignedUrl {
	return v.value
}

func (v *NullableCcpmV1UploadSourcePresignedUrl) Set(val *CcpmV1UploadSourcePresignedUrl) {
	v.value = val
	v.isSet = true
}

func (v NullableCcpmV1UploadSourcePresignedUrl) IsSet() bool {
	return v.isSet
}

func (v *NullableCcpmV1UploadSourcePresignedUrl) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCcpmV1UploadSourcePresignedUrl(val *CcpmV1UploadSourcePresignedUrl) *NullableCcpmV1UploadSourcePresignedUrl {
	return &NullableCcpmV1UploadSourcePresignedUrl{value: val, isSet: true}
}

func (v NullableCcpmV1UploadSourcePresignedUrl) MarshalJSON() ([]byte, error) {
	buffer := &bytes.Buffer{}
	encoder := json.NewEncoder(buffer)
	encoder.SetEscapeHTML(false)
...
func (v *NullableCcpmV1UploadSourcePresignedUrl) UnmarshalJSON(src []byte) error {
	v.isSet = true
