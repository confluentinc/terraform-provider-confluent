...
func NewCcpmV1CustomConnectPluginVersion() *CcpmV1CustomConnectPluginVersion {
	this := CcpmV1CustomConnectPluginVersion{}
	return &this
}
...
func (o *CcpmV1CustomConnectPluginVersion) GetSpec() CcpmV1CustomConnectPluginVersionSpec {
	if o == nil || o.Spec == nil {
		var ret CcpmV1CustomConnectPluginVersionSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given CcpmV1CustomConnectPluginVersionSpec and assigns it to the Spec field.
...
func (o *CcpmV1CustomConnectPluginVersion) GetStatus() CcpmV1CustomConnectPluginVersionStatus {
	if o == nil || o.Status == nil {
		var ret CcpmV1CustomConnectPluginVersionStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given CcpmV1CustomConnectPluginVersionStatus and assigns it to the Status field.
func (o *CcpmV1CustomConnectPluginVersion) SetStatus(v CcpmV1CustomConnectPluginVersionStatus) {
	o.Status = &v
}

// Redact resets all sensitive fields to their zero value.
func (o *CcpmV1CustomConnectPluginVersion) Redact() {
...
func (o *CcpmV1CustomConnectPluginVersion) recurseRedact(v interface{}) {
...
func (o CcpmV1CustomConnectPluginVersion) zeroField(v interface{}) {
	p := reflect.ValueOf(v).Elem()
	p.Set(reflect.Zero(p.Type()))
}

func (o CcpmV1CustomConnectPluginVersion) MarshalJSON() ([]byte, error) {
...
type NullableCcpmV1CustomConnectPluginVersion struct {
	value *CcpmV1CustomConnectPluginVersion
	isSet bool
}

func (v NullableCcpmV1CustomConnectPluginVersion) Get() *CcpmV1CustomConnectPluginVersion {
	return v.value
}

func (v *NullableCcpmV1CustomConnectPluginVersion) Set(val *CcpmV1CustomConnectPluginVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableCcpmV1CustomConnectPluginVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableCcpmV1CustomConnectPluginVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCcpmV1CustomConnectPluginVersion(val *CcpmV1CustomConnectPluginVersion) *NullableCcpmV1CustomConnectPluginVersion {
	return &NullableCcpmV1CustomConnectPluginVersion{value: val, isSet: true}
}

func (v NullableCcpmV1CustomConnectPluginVersion) MarshalJSON() ([]byte, error) {
	buffer := &bytes.Buffer{}
	encoder := json.NewEncoder(buffer)
	encoder.SetEscapeHTML(false)
...
func (v *NullableCcpmV1CustomConnectPluginVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
