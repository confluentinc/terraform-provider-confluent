...
require (
	...
	github.com/confluentinc/ccloud-sdk-go-v2/connect-custom-plugin v0.0.8
	github.com/confluentinc/ccloud-sdk-go-v2/data-catalog v0.3.0
	github.com/confluentinc/ccloud-sdk-go-v2/flink v0.10.0
