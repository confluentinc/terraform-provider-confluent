		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(fullTableDataSourceLabel, "watermark.#", "1"),
					resource.TestCheckResourceAttr(fullTableDataSourceLabel, "watermark.0.column", "col123"),
					resource.TestCheckResourceAttr(fullTableDataSourceLabel, "watermark.0.expression", "exp123"),
					resource.TestCheckResourceAttr(fullTableDataSourceLabel, "start_mode.#", "1"),
					resource.TestCheckResourceAttr(fullTableDataSourceLabel, "start_mode.0.kind", "FROM_NOW"),
					resource.TestCheckResourceAttr(fullTableDataSourceLabel, "start_mode.0.time_interval.#", "1"),
					resource.TestCheckResourceAttr(fullTableDataSourceLabel, "start_mode.0.time_interval.0.interval", "2"),
					resource.TestCheckResourceAttr(fullTableDataSourceLabel, "start_mode.0.time_interval.0.time_unit", "HOURS"),
					...
					resource.TestCheckResourceAttr(fullTableDataSourceLabel, "constraints.0.type", "PRIMARY_KEY"),
					resource.TestCheckResourceAttr(fullTableDataSourceLabel, "constraints.0.enforced", "false"),
					resource.TestCheckResourceAttr(fullTableDataSourceLabel, "constraints.0.columns.#", "2"),
					resource.TestCheckTypeSetElemAttr(fullTableDataSourceLabel, "constraints.0.columns.*", "user_id"),
					resource.TestCheckTypeSetElemAttr(fullTableDataSourceLabel, "constraints.0.columns.*", "product_id"),
