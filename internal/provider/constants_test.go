...
const (
	...
	flinkComputePoolRestEndpoint                                        = "https://flinkv2.us-east-2.aws.confluent.cloud/sql/v1alpha1/environments/env-gz903"
	...
	flinkRegionRestEndpoint                                             = "https://flinkv2.us-east-1.aws.confluent.cloud"
	flinkRegionRestEndpointPrivate                                      = "https://flinkv2.us-east-1.aws.private.confluent.cloud"
	...
	gcpProviderIntegrationV2ConfluentSA                                 = "cspi-def456@cflt-cspi-prod-1.iamv2.gserviceaccount.com"
	gcpProviderIntegrationV2CustomerSA                                  = "test-sa@test-project.iamv2.gserviceaccount.com"
	...
	scenarioArtifactPresignedUrlHasBeenCreated                          = "The new flinkv2 artifact predesign URL has been just created"
	scenarioConnectArtifactPresignedUrlHasBeenCreated                   = "The new connectv1 artifact presigned URL has been just created"
	...
	scenarioStateConnectArtifactHasBeenCreated                          = "The new connectv1 artifact has been just created"
	scenarioStateConnectArtifactHasBeenDeleted                          = "The new connectv1 artifact has been deleted"
	scenarioStateConnectArtifactIsProvisioning                          = "The new connectv1 artifact is in provisioning state"
	...
	scenarioStateDnsForwarderHasBeenCreated                             = "The new networkingdnsforwarderv1 forwarder has been created"
	scenarioStateDnsForwarderIsProvisioning                             = "The new networkingdnsforwarderv1 forwarder is provisioning"
	scenarioStateDnsRecordHasBeenCreated                                = "The new networkingdnsforwarderv1 record has been just created"
	scenarioStateDnsRecordHasBeenDeleted                                = "The new dms record's deletion has been just completed"
	scenarioStateDnsRecordHasBeenUpdated                                = "The new networkingdnsforwarderv1 record has been updated"
	scenarioStateDnsRecordIsDeprovisioning                              = "The new networkingdnsforwarderv1 record is deprovisioning"
	scenarioStateDnsRecordIsProvisioning                                = "The new networkingdnsforwarderv1 record is provisioning"
	...
	scenarioStateFlinkApiKeyHasBeenCreated                              = "The new flinkv2 api key has been just created"
	scenarioStateFlinkApiKeyHasBeenDeleted                              = "The new flinkv2 api key has been deleted"
	scenarioStateFlinkApiKeyHasBeenSyncedConfirmationRead               = "The new flinkv2 api key has been just synced (final read)"
	scenarioStateFlinkApiKeyHasBeenSyncedFirstRead                      = "The new flinkv2 api key has been just synced (read #1)"
	scenarioStateFlinkApiKeyHasBeenUpdated                              = "The new flinkv2 api key's description and display_name have been just updated"
	scenarioStateFlinkArtifactHasBeenCreated                            = "The new flinkv2 artifact has been just created"
	scenarioStateFlinkArtifactHasBeenDeleted                            = "The new flinkv2 artifact has been deleted"
