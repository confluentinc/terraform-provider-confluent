		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(fullTopicDataSourceLabel, "config.%", "5"),
					...
					resource.TestCheckResourceAttr(fullTopicDataSourceLabel, fmt.Sprintf("config.%s", seventhConfigName), seventhConfigValue),
					resource.TestCheckResourceAttr(fullTopicDataSourceLabel, fmt.Sprintf("config.%s", eighthConfigName), eighthConfigValue),
				),
			},
		},
	})
