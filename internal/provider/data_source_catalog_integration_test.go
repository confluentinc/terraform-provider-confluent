		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(CatalogIntegrationResourceName, "last_sync_at", "2024-02-01T22:25:50.415274Z"),
					resource.TestCheckResourceAttr(CatalogIntegrationResourceName, "catalog_integration_aws_glue.#", "1"),
					resource.TestCheckResourceAttr(CatalogIntegrationResourceName, "catalog_integration_snowflake.#", "0"),
					resource.TestCheckResourceAttr(CatalogIntegrationResourceName, "catalog_integration_aws_glue.0.provider_integration_id", "cspi-stgce89r7"),
				),
			},
		},
	})
