		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(fullAzureNetworkResourceLabel, "gateway.#", "1"),
					resource.TestCheckResourceAttr(fullAzureNetworkResourceLabel, "gateway.0.%", "1"),
					resource.TestCheckResourceAttr(fullAzureNetworkResourceLabel, "gateway.0.id", ""),
