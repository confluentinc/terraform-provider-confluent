...
const (
	...
	azureIngressAccessPointScenarioName                = "confluent_access_point Azure Ingress Private Link Endpoint Resource Lifecycle"
	gcpEgressAccessPointScenarioName                   = "confluent_access_point Gcp Egress Private Link Endpoint Resource Lifecycle"
	gcpIngressAccessPointScenarioName                  = "confluent_access_point Gcp Ingress Private Service Connect Endpoint Resource Lifecycle"
...
func TestAccAccessPointAwsIngressPrivateLinkEndpoint(t *testing.T) {
	ctx := context.Background()
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckResourceAccessPointAwsIngressWithIdSet(mockServerUrl, "prod-ingress-ap-1"),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(accessPointResourceLabel, "id", "ap-ingress123"),
					resource.TestCheckResourceAttr(accessPointResourceLabel, "display_name", "prod-ingress-ap-1"),
					resource.TestCheckResourceAttr(accessPointResourceLabel, "environment.#", "1"),
					resource.TestCheckResourceAttr(accessPointResourceLabel, "environment.0.id", "env-abc123"),
					resource.TestCheckResourceAttr(accessPointResourceLabel, "gateway.#", "1"),
					resource.TestCheckResourceAttr(accessPointResourceLabel, "gateway.0.id", "gw-ingress123"),
					resource.TestCheckResourceAttr(accessPointResourceLabel, "aws_ingress_private_link_endpoint.#", "1"),
					resource.TestCheckResourceAttr(accessPointResourceLabel, "aws_egress_private_link_endpoint.#", "0"),
					resource.TestCheckResourceAttr(accessPointResourceLabel, "aws_private_network_interface.#", "0"),
					resource.TestCheckResourceAttr(accessPointResourceLabel, "azure_egress_private_link_endpoint.#", "0"),
					resource.TestCheckResourceAttr(accessPointResourceLabel, "gcp_egress_private_service_connect_endpoint.#", "0"),
					resource.TestCheckResourceAttr(accessPointResourceLabel, "aws_ingress_private_link_endpoint.0.vpc_endpoint_id", "vpce-00000000000000000"),
					resource.TestCheckResourceAttr(accessPointResourceLabel, "aws_ingress_private_link_endpoint.0.vpc_endpoint_service_name", "com.amazonaws.vpce.us-west-2.vpce-svc-00000000000000000"),
					resource.TestCheckResourceAttr(accessPointResourceLabel, "aws_ingress_private_link_endpoint.0.dns_domain", "ap123abc.us-west-2.aws.accesspoint.confluent.cloud"),
				),
			},
			{
				Config: testAccCheckResourceAccessPointAwsIngressWithIdSet(mockServerUrl, "prod-ingress-ap-2"),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(accessPointResourceLabel, "id", "ap-ingress123"),
					resource.TestCheckResourceAttr(accessPointResourceLabel, "display_name", "prod-ingress-ap-2"),
					resource.TestCheckResourceAttr(accessPointResourceLabel, "environment.#", "1"),
					resource.TestCheckResourceAttr(accessPointResourceLabel, "environment.0.id", "env-abc123"),
					resource.TestCheckResourceAttr(accessPointResourceLabel, "gateway.#", "1"),
					resource.TestCheckResourceAttr(accessPointResourceLabel, "gateway.0.id", "gw-ingress123"),
...
func testAccCheckResourceAccessPointAwsIngressWithIdSet(mockServerUrl, name string) string {
	return fmt.Sprintf(`
    provider "confluent" {
        endpoint = "%s"
    }
