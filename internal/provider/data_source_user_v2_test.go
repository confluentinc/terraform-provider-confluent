...
const (
	...
	userDataSourceScenarioName = "confluent_user_v2 Data Source Lifecycle"
	userId                     = "u-1jjv23"
...
func TestAccDataSourceUser(t *testing.T) {
	...
	fullUserDataSourceLabel := fmt.Sprintf("data.confluent_user_v2.%s", userResourceLabel)
