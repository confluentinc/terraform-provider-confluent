...
func TestAccClusterLinkBidirectionalInbound(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckClusterLinkBidirectionalInboundConfig(confluentCloudBaseUrl, mockClusterLinkTestServerUrl),
...
func testAccCheckClusterLinkBidirectionalInboundConfig(confluentCloudBaseUrl, mockServerUrl string) string {
	return fmt.Sprintf(`
	provider "confluent" {
	  endpoint = "%s"
	}
	...
	`, confluentCloudBaseUrl, clusterLinkResourceLabel,
		clusterLinkName, linkModeBidirectional, connectionModeInbound,
		sourceClusterId, mockServerUrl, sourceClusterApiKey, sourceClusterApiSecret,
		destinationClusterId, destinationClusterBootstrapEndpoint)
}
