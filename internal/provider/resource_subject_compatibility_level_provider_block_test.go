...
const (
	...
	subjectCompatibilityLevelScenarioName                = "confluent_subject_compatibility_level Resource Lifecycle"
...
var fullSubjectCompatibilityLevelResourceLabel = fmt.Sprintf("confluent_subject_compatibility_level.%s", testSubjectCompatibilityLevelResourceLabel)
...
func testAccCheckSubjectCompatibilityLevelConfigWithEnhancedProviderBlock(confluentCloudBaseUrl, mockServerUrl, compatibilityLevel string) string {
	...
	`, confluentCloudBaseUrl, testSchemaRegistryKey, testSchemaRegistrySecret, mockServerUrl, testSubjectCompatibilityLevelResourceLabel, testStreamGovernanceClusterId, testSubjectName, compatibilityLevel)
}
