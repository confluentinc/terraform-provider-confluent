		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(fullKafkaClustersDataSourceLabel, "clusters.0.basic.0.%", "1"),
					...
					resource.TestCheckResourceAttr(fullKafkaClustersDataSourceLabel, "clusters.0.byokv1.#", "0"),
					...
					resource.TestCheckResourceAttr(fullKafkaClustersDataSourceLabel, "clusters.1.basic.0.%", "1"),
					...
					resource.TestCheckResourceAttr(fullKafkaClustersDataSourceLabel, "clusters.1.byokv1.#", "0"),
