		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.%", "3"),
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.domain_rules.#", "2"),
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.domain_rules.0.%", "11"),
					...
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.domain_rules.0.on_failure", "ERROR,ERROR"),
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.domain_rules.0.on_success", "NONE,NONE"),
					...
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.domain_rules.0.disabled", "false"),
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.domain_rules.1.%", "11"),
					...
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.domain_rules.1.on_failure", "ERROR,ERROR"),
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.domain_rules.1.on_success", "NONE,NONE"),
					...
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.domain_rules.1.disabled", "false"),
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.migration_rules.#", "1"),
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.migration_rules.0.%", "11"),
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.migration_rules.0.name", "encrypt"),
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.migration_rules.0.kind", "TRANSFORM"),
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.migration_rules.0.type", "ENCRYPT"),
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.migration_rules.0.mode", "WRITEREAD"),
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.migration_rules.0.tags.#", "1"),
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.migration_rules.0.tags.0", "PIm"),
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.migration_rules.0.params.%", "1"),
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.migration_rules.0.params.encrypt.kek.name", "testkekM"),
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.migration_rules.0.disabled", "false"),
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.encoding_rules.#", "1"),
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.encoding_rules.0.%", "11"),
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.encoding_rules.0.name", "encryptCSPE"),
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.encoding_rules.0.kind", "TRANSFORM"),
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.encoding_rules.0.type", "ENCRYPT"),
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.encoding_rules.0.mode", "WRITEREAD"),
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.encoding_rules.0.tags.#", "1"),
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.encoding_rules.0.tags.0", "CSPE"),
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.encoding_rules.0.params.%", "1"),
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.encoding_rules.0.params.encrypt.kek.name", "cspe-kek"),
					resource.TestCheckResourceAttr(fullSchemaDataSourceLabel, "ruleset.0.encoding_rules.0.disabled", "false"),
