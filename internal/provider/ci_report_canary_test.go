...
// TestAccCiReportCanary fails on purpose. It exists only so this branch's CI run produces a real
// failed acceptance test, which is the only way to see what the Semaphore Test Report actually
// contains for a failure. DELETE THIS FILE BEFORE MERGING.
//
