...
const (
	...
	rtce_topicScenarioName               = "confluent_rtce_rtce_topic Resource Lifecycle"
...
func TestAccRtceRtceTopic(t *testing.T) {
	...
	fullRtceTopicResourceLabel := fmt.Sprintf("confluent_rtce_rtce_topic.%s", rtce_topicResourceLabel)
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(fullRtceTopicResourceLabel, "resource_name", "crn://confluent.cloud/organization=abc/environment=env-abc123/rtce_topic=orders_topic"),
				),
			},
			{
