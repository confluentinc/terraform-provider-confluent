...
func TestAccConnectArtifactAzure(t *testing.T) {
	...
	createArtifactPresignedUrlResponse, _ := os.ReadFile("../testdata/connect_artifact/read_presigned_url_azure.json")
	...
	provisioningArtifactResponse, _ := os.ReadFile("../testdata/connect_artifact/create_artifact_azure.json")
	_ = wiremockClient.StubFor(wiremock.Get(wiremock.URLPathEqualTo(connectArtifactsUrlPath)).
		InScenario(connectArtifactScenarioName).
		WithQueryParam("spec.cloud", wiremock.Matching("(?i)^"+regexp.QuoteMeta(connectArtifactCloudAzureAPIResponse)+"$")).
	...
	_ = wiremockClient.StubFor(wiremock.Get(wiremock.URLPathEqualTo(connectArtifactsUrlPath)).
		InScenario(connectArtifactScenarioName).
		WithQueryParam("spec.cloud", wiremock.Matching("(?i)^"+regexp.QuoteMeta(connectArtifactCloudAzure)+"$")).
		WithQueryParam("environment", wiremock.EqualTo(connectArtifactEnvironmentId)).
	...
	resource.Test(t, resource.TestCase{
		...
		CheckDestroy:      testAccCheckConnectArtifactDestroyAzure,
		Steps: []resource.TestStep{
			{
				Config: testAccCheckConnectArtifactAzureConfig(mockServerUrl, connectArtifactResourceLabel),
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(fullConnectArtifactResourceLabel, paramCloud, connectArtifactCloudAzureAPIResponse),
...
func testAccCheckConnectArtifactAzureConfig(mockServerUrl, resourceLabel string) string {
	return fmt.Sprintf(`
	provider "confluent" {
		endpoint = "%s"
	}
	...
	`, mockServerUrl, resourceLabel, connectArtifactUniqueName, connectArtifactCloudAzure, connectArtifactContentFormat, connectArtifactDescription, connectArtifactEnvironmentId)
}
