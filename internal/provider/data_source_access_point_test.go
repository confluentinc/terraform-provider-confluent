		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(fullAccessPointResourceName, "aws_private_network_interface.0.routes.#", "2"),
					resource.TestCheckResourceAttr(fullAccessPointResourceName, "aws_private_network_interface.0.routes.0", "172.31.0.0/16"),
					resource.TestCheckResourceAttr(fullAccessPointResourceName, "aws_private_network_interface.0.routes.1", "10.108.16.0/21"),
				),
			},
		},
	})
