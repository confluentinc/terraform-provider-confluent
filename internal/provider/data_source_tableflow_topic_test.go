		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(TableflowTopicResourceName, "azure_data_lake_storage_gen_2.#", "0"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(TableflowTopicResourceName, "error_handling.0.mode", "SUSPEND"),
...
func TestAccDataSourceTableflowTopicAzure(t *testing.T) {
	ctx := context.Background()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(TableflowTopicResourceName, "byob_aws.#", "0"),
					resource.TestCheckResourceAttr(TableflowTopicResourceName, "managed_storage.#", "0"),
					resource.TestCheckResourceAttr(TableflowTopicResourceName, "azure_data_lake_storage_gen_2.#", "1"),
					resource.TestCheckResourceAttr(TableflowTopicResourceName, "azure_data_lake_storage_gen_2.0.container_name", "Container1"),
					resource.TestCheckResourceAttr(TableflowTopicResourceName, "azure_data_lake_storage_gen_2.0.storage_account_name", "Acc1"),
					resource.TestCheckResourceAttr(TableflowTopicResourceName, "azure_data_lake_storage_gen_2.0.storage_region", "US1"),
					resource.TestCheckResourceAttr(TableflowTopicResourceName, "azure_data_lake_storage_gen_2.0.provider_integration_id", "cspi-stgce89r7"),
					resource.TestCheckResourceAttr(TableflowTopicResourceName, "table_path", "s3://dummy-bucket-name-1//10011010/11101100/org-1/env-2/lkc-3/v1/tableId2"),
					resource.TestCheckResourceAttr(TableflowTopicResourceName, "write_mode", "UPSERT"),
				),
			},
		},
