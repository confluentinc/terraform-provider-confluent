		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(switchoverPairResourceLabel, "failover_type", "CLEAN"),
					resource.TestCheckResourceAttr(switchoverPairResourceLabel, "phase", "READY"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(switchoverPairDataSourceLabel, "phase", "READY"),
