...
const (
	...
	connectArtifactApiVersion                         = "artifact/v1"
	connectArtifactKind                               = "ConnectArtifact"
)
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(fullConnectArtifactResourceLabel, paramApiVersion, connectArtifactApiVersion),
					resource.TestCheckResourceAttr(fullConnectArtifactResourceLabel, paramKind, connectArtifactKind),
				),
			},
			{
